...
class Moderation(commands.Cog, name="Moderation"):
            ...
            if view.value is None:
                ...
                for channel in ctx.guild.channels:
                    await channel.set_permissions(
                        ...
                        send_messages=False, read_messages=None, view_channel=None,
                    )
                embed = nextcord.Embed(
    ...
    async def unlock(self, ctx, channel: nextcord.TextChannel = None, setting=None):
        if setting == '--server':
            for channel in ctx.guild.channels:
                await channel.set_permissions(
                    ...
                    send_messages=None, view_channels=None, read_messages=None,
                )
            embed = nextcord.Embed(
        ...
        await channel.set_permissions(
            ...
            send_messages=None, read_messages=None, view_channel=None,
        )
        embed = nextcord.Embed(
            title="Unlock Success",
